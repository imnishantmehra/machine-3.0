...
export default function AccountSettings() {
  ...
  const [linkedinMessageType, setLinkedinMessageType] = useState<
    "success" | "error" | null
  >(null);
  const [twitterMessageType, setTwitterMessageType] = useState<
    "success" | "error" | null
  >(null);
  const [wordpressMessageType, setWordpressMessageType] = useState<
    "success" | "error" | null
  >(null);
